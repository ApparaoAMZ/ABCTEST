...
public class SqlQueriesConstant {
	...
	public static String GDPR_DEPERSONALIZATION_INPUT = "INSERT INTO GDPR.GDPR_DEPERSONALIZATION (RUN_ID, CANDIDATE__C, CATEGORY_ID, "
			+ "COUNTRY_CODE, HVH_STATUS, HEROKU_STATUS1) VALUES (?, ?, ?, ?, ?, ?)";		
	...
	//BackupServiceQueris
	public static String GDPR_SUMMARYDATA_FETCH = "SELECT SUMMARY_ID,RUN_ID,CATEGORY_ID,REGION,COUNTRY_CODE,IMPACT_TABLE_ID,IMPACT_TABLE_NAME,BACKUP_QUERY,DEPERSONALIZATION_QUERY FROM  GDPR.RUN_SUMMARY_MGMT WHERE RUN_ID12=";	
