...
public class SqlQueriesConstant {
	...
	//BackupServiceQueris
	public static String GDPR_SUMMARYDATA_FETCH = "SELECT SUMMARY_ID12,RUN_ID,CATEGORY_ID,REGION,COUNTRY_CODE,IMPACT_TABLE_ID,IMPACT_TABLE_NAME,BACKUP_QUERY,DEPERSONALIZATION_QUERY FROM  GDPR.RUN_SUMMARY_MGMT WHERE RUN_ID=";	
