...
public class SqlQueriesConstant {
	...
	public static String RUN_SUMMARY_MGMT_BKP_FETCH = "SELECT SUMMARY_ID, RUN_ID, CATEGORY_ID, COUNTRY_CODE, IMPACT_TABLE_ID, IMPACT_TABLE_NAME, "
			+ " BACKUP_QUERY, DEPERSONALIZATION_QUERY, TAGGED_QUERY FROM GDPR.RUN_SUMMARY_MGMT WHERE RUN_ID = ? "
			+ " ORDER BY RUN_ID, SUMMARY_ID";
	
	public static String RUN_SUMMARY_MGMT_BKP_UPDATE = "UPDATE GDPR.RUN_SUMMARY_MGMT SET "
			+ "BACKUP_ROW_COUNT = ? WHERE SUMMARY_ID = ?";
